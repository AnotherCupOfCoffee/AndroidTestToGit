    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button3.setOnClickListener(new Button.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent myIntent = new Intent(MainActivity.this, ExampleActivity3.class);
        ...
        button4.setOnClickListener(new Button.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent myIntent = new Intent(MainActivity.this, ExampleActivity4.class);
        ...
        button5.setOnClickListener(new Button.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent myIntent = new Intent(MainActivity.this, ExampleActivity5.class);
